                ...
                <div className="col-md-6 col-sm-12 mt-4">
                    ...
                    <div className='d-flex justify-content-around'>
                        ...
                        <div className="form-check">
                            <input className="form-check-input no-radio" type="radio" name={"melting" + props.number} id={"op1" + props.number} value="18" onChange={props.handleMelting} disabled={disable} onClick={handleMeltingButton}/>
