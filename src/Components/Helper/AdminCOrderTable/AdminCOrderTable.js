...
import '../../Admin/AdminCompletedOrders/AdminCompletedOrder.css';
...
function AdminCOrderTable() {
  ...
  orders.data.order && orders.data.order.map((o,index)=>{
      if (o.orderStatus==6) {
        odata.push(orders.data.order[index])
      }
  })
...
export default AdminCOrderTable;
